...
//   const [form, setForm] = useState<IPaymentMethod>({ name: "", provider: "", publicKey: "", active: true });
...
//   const validateForm = () => {
//     if (!form.name || !form.provider || !form.publicKey) {
...
//         setForm({ name: "", provider: "", publicKey: "", active: true });
...
//       });
//       const data = await res.json();
//       if (res.ok && data.success) fetchMethods();
...
//               <CreditCard size={16} /> {editingMethod ? "Edit Method" : "Add Method"}
//             </Button>
//           </DialogTrigger>
//           <DialogContent>
//             <DialogHeader>
...
//                 {isProcessing ? "Processing..." : editingMethod ? "Update" : "Save"}
//               </Button>
//             </div>
//           </DialogContent>
//         </Dialog>
...
//                       <DropdownMenuItem
//                         onClick={() => { setEditingMethod(m); setForm(m); setDialogOpen(true); }}
//                       >✏️ Edit</DropdownMenuItem>
//                       <DropdownMenuItem
...
// }
export default function PaymentMethodPage() {
  return <div>Payment Methods Management Page</div>;
}